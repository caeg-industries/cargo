...
use super::manifest::{
    SUBCRATE_DELIMETER_REGISTRY_FILENAME_REPLACEMENT, SUBCRATE_DELIMETER_RUST_CODE_REPLACEMENT,
};
...
impl Package {
    ...
    pub fn registry_safe_file_name(&self) -> InternedString {
        let i_str = self.package_id().name().replace(
            SUBCRATE_DELIMETER,
    ...
    pub fn rust_code_safe_name(&self) -> InternedString {
        let i_str = self
            .package_id()
            .name()
